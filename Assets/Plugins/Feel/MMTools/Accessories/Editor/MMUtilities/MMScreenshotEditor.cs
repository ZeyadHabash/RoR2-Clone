...
namespace MoreMountains.Tools
{
    ...
    public class MMScreenshotEditor : Editor
    {
        ...
        protected static string TakeScreenCaptureScreenshot(int gameViewSizeMultiplier)
        {
            ...
            string savePath = FolderName + "/screenshot_" + width + "x" + height + "_" +
                              System.DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss") + ".png";

            ScreenCapture.CaptureScreenshot(savePath, gameViewSizeMultiplier);
            MMDebug.DebugLogInfo("[MMScreenshot] Screenshot taken with size multiplier of " + gameViewSizeMultiplier +

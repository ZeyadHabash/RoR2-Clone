        ...
        protected virtual void Rotation()
        {
            ...
            if (Mode == Modes.Touch && (Input.touchCount > 0))
            {
                if ((Input.touches[0].phase == TouchPhase.Moved) && (Input.touchCount == 1))
                {
                    ...
                    _angleX += Input.touches[0].deltaPosition.x * RotationSpeed.x * Time.deltaTime * swipeSpeed *
                               0.00001f;
                    _angleY -= Input.touches[0].deltaPosition.y * RotationSpeed.y * Time.deltaTime * swipeSpeed *
                               0.00001f;
        ...
        protected virtual void Zoom()
        {
            ...
            if (Mode == Modes.Touch && (Input.touchCount > 0))
            {
                if (Input.touchCount == 2)
                {
                    ...
                    _desiredDistance += deltaMagnitudeDifference * Time.deltaTime * ZoomSpeed *
                                        Mathf.Abs(_desiredDistance) * 0.001f;

...
namespace MoreMountains.Tools
{
    ...
    public class MMPath : MonoBehaviour
    {
        ...
        [Header("Gizmos")] public bool LockHandlesOnXAxis = false;
        ...
        public virtual void Initialization()
        {
            ...
            if ((ReferenceMMPath != null) &&
                (ReferenceMMPath.PathElements != null || ReferenceMMPath.PathElements.Count > 0))
            {
        ...
        protected virtual void ComputePath()
        {
            ...
            _distanceToNextPoint = (this.transform.position - (_originalTransformPosition + _currentPoint.Current))
                .magnitude;
        ...
        protected virtual void OnDrawGizmos()
        {
            ...
            for (int i = 0; i < PathElements.Count; i++)
            {
                ...
                MMDebug.DrawGizmoPoint(_originalTransformPosition + PathElements[i].PathElementPosition, 0.2f,
                    Color.green);
        ...
        public void SetPath(in Data configuration)
        {
            ...
            foreach (var offset in configuration.Offsets)
            {
                PathElements.Add(new MMPathMovementElement()
                    { Delay = configuration.Delay, PathElementPosition = offset });
            }

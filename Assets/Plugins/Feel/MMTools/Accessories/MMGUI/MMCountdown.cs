...
namespace MoreMountains.Tools
{
    ...
    public class MMCountdown : MMMonoBehaviour
    {
        ...
        [MMInspectorGroup("Debug", true, 17)] [MMReadOnly]
        ...
        [MMInspectorButton("StopCountdown")] public bool StopCountdownButton;

        /// Debug button to start the countdown
        [MMInspectorButton("StartCountdown")] public bool StartCountdownButton;

        /// Debug button to reset the countdown
        [MMInspectorButton("ResetCountdown")] public bool ResetCountdownButton;

        /// Debug button to change the direction of the countdown
        [MMInspectorButton("ChangeDirection")] public bool ChangeDirectionButton;
        ...
        protected virtual void Initialization()
        {
            ...
            Direction = (CountdownFrom > CountdownTo)

    ...
    public class MMPlotter : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if (Time.unscaledTime - _lastMovementEndedAt < MovementPauseDuration)
            {
                ...
                {
                    _currentMovement = 0f;
                    _newScaleUnit = MMTween.Tween(Time.unscaledTime - _lastMovementEndedAt,
                        (MovementPauseDuration / 2f), MovementPauseDuration, 0f, 1f, MMTween.MMTweenCurve.EaseOutCubic);
                    _newScale = Vector3.one * _newScaleUnit;

...
namespace MoreMountains.Tools
{
    ...
    {
        private static readonly Dictionary<string, MMSpeedTestItem> _speedTests =
            new Dictionary<string, MMSpeedTestItem>();
        ...
        public static void EndTest(string testID)
        {
            ...
            MMDebug.DebugLogInfo("<color=red>MMSpeedTest</color> [Test " + testID + "] test duration : " + elapsedTime +
                                 "s");
        }
    }
}
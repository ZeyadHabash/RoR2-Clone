...
namespace MoreMountains.Tools
{
    ...
    public struct MMInterval<T> where T : struct, IComparable
    {
        ...
        public MMInterval(T lowerBound, T upperBound, MMIntervalType lowerboundIntervalType = MMIntervalType.Inclusive,
            MMIntervalType upperboundIntervalType = MMIntervalType.Inclusive) : this()
        {
            T a = lowerBound;
            T b = upperBound;
        ...
        {
            bool lowerBoundCheck = LowerBoundIntervalType == MMIntervalType.Exclusive
                ? LowerBound.CompareTo(value) < 0
                : LowerBound.CompareTo(value) <= 0;
            bool upperBoundCheck = UpperBoundIntervalType == MMIntervalType.Exclusive

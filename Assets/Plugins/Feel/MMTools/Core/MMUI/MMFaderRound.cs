...
namespace MoreMountains.Tools
{
    ...
    public class MMFaderRound : MMMonoBehaviour, MMEventListener<MMFadeEvent>, MMEventListener<MMFadeInEvent>,
        MMEventListener<MMFadeOutEvent>, MMEventListener<MMFadeStopEvent>
    {
        ...
        [MMInspectorGroup("Mask", true, 127)] [MMVector("min", "max")]
        ...
        [MMInspectorGroup("Debug", true, 126)] public Transform DebugWorldPositionTarget;
        ...
        protected virtual void StartFading(float initialAlpha, float endAlpha, float duration, MMTweenType curve,
            int id,

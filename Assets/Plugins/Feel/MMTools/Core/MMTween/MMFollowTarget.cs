...
namespace MoreMountains.Tools
{
    ...
    public class MMFollowTarget : MonoBehaviour
    {
        ...
        /// higher values mean more damping, less spring, low values mean less damping, more spring
        [MMEnumCondition("FollowRotationMode", (int)FollowModes.MMSpring)] [Range(0.01f, 1.0f)]
        ...
        /// higher values mean more damping, less spring, low values mean less damping, more spring
        [MMEnumCondition("FollowScaleMode", (int)FollowModes.MMSpring)] [Range(0.01f, 1.0f)]
            ...
            if (InterpolatePosition)
            {
                switch (FollowPositionMode)
                {
                    ...
                    case FollowModes.MMSpring:
                        ...
                        MMMaths.Spring(ref _newPosition, _newTargetPosition, ref _positionVelocity,
                            PositionSpringDamping, PositionSpringFrequency, Time.deltaTime);
                        if (_localSpace)
                        {
        ...
        protected virtual void FollowTargetRotation()
        {
            ...
            if (FollowRotationMode == FollowModes.MMSpring &&
            ...
            if (InterpolateRotation)
            {
                ...
                {
                    case FollowModes.MMLerp:
                        this.transform.rotation = MMMaths.Lerp(this.transform.rotation, _newTargetRotation,
                    ...
                    case FollowModes.MMSpring:
                        ...
                        MMMaths.Spring(ref _rotationFloatCurrent, _rotationFloatTarget, ref _rotationFloatVelocity,
                            RotationSpringDamping, RotationSpringFrequency, Time.deltaTime);
                        float lerpValue = MMMaths.Remap(_rotationFloatCurrent, 0f, _rotationFloatTarget, 0f, 1f);
                        this.transform.rotation =
                            Quaternion.LerpUnclamped(_rotationBeforeSpring, _newTargetRotation, lerpValue);
                        break;
                }
            }
            else
        ...
        protected virtual void FollowTargetScale()
        {
            ...
            if (InterpolateScale)
            {
                ...
                {
                    case FollowModes.MMLerp:
                        this.transform.localScale = MMMaths.Lerp(this.transform.localScale, _newTargetScale,
                            FollowScaleSpeed, Time.deltaTime);
                        break;
                    case FollowModes.RegularLerp:
                        this.transform.localScale = Vector3.Lerp(this.transform.localScale, _newTargetScale,
                            Time.deltaTime * FollowScaleSpeed);
                        break;
                    case FollowModes.MMSpring:
                        _newScale = this.transform.localScale;
                        MMMaths.Spring(ref _newScale, _newTargetScale, ref _scaleVelocity, ScaleSpringDamping,
                            ScaleSpringFrequency, Time.deltaTime);

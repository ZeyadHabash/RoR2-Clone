...
namespace MoreMountains.Tools
{
    ...
    public class MMPersistenceManager : MMPersistentSingleton<MMPersistenceManager>, MMEventListener<MMGameEvent>
    {
        ...
        [Header("Debug Buttons (Only at Runtime)")] [MMInspectorButton("SaveToMemory")]
        public bool SaveToMemoryButton;

        [MMInspectorButton("LoadFromMemory")] public bool LoadFromMemoryButton;
        ...
        {
            MMPersistenceManagerData saveData =
                (MMPersistenceManagerData)MMSaveLoadManager.Load(typeof(MMPersistenceManagerData), DetermineSaveName(),
                    _saveFolderName);

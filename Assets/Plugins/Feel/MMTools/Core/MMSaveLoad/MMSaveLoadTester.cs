...
namespace MoreMountains.Tools
{
    ...
    public class MMSaveLoadTester : MonoBehaviour
    {
        ...
        [Tooltip("the extension to use")] public string SaveFileExtension = ".testObject";
        ...
        {
            InitializeSaveLoadMethod();
            MMSaveLoadTestObject testObject = (MMSaveLoadTestObject)MMSaveLoadManager.Load(typeof(MMSaveLoadTestObject),

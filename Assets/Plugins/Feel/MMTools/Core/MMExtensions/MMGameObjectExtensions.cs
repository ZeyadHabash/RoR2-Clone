...
namespace MoreMountains.Tools
{
    ...
    public static class GameObjectExtensions
    {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static (T newComponent, bool createdNew) MMFindOrCreateObjectOfType<T>(this GameObject @this,
            string newObjectName, Transform parent, bool forceNewCreation = false) where T : Component
        {

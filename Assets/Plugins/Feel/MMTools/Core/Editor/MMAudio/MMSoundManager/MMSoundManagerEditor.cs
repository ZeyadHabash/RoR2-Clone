...
namespace MoreMountains.Tools
{
    ...
    public class MMSoundManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                DrawTrack("Master Track", _mmSoundManager.settingsSo.Settings.MasterOn,
                ...
                DrawTrack("Music Track", _mmSoundManager.settingsSo.Settings.MusicOn,
                ...
                DrawTrack("SFX Track", _mmSoundManager.settingsSo.Settings.SfxOn,
                ...
                DrawTrack("UI Track", _mmSoundManager.settingsSo.Settings.UIOn, MMSoundManager.MMSoundManagerTracks.UI,
                    _uiColorMute, _uiColorUnmute, _uiColorPause, _uiColorStop, _uiColorPlay, _uiColorFree);
                DrawSaveLoadButtons();
            }
        }
            ...
            Color muteColor, Color unmuteColor, Color pauseColor, Color stopColor, Color playColor, Color freeColor)
        {
            ...
            switch (track)
            {
                case MMSoundManager.MMSoundManagerTracks.Master:
                    ...
                    {
                        _mmSoundManager.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Master,
                            newVolume);
                    }
                ...
                case MMSoundManager.MMSoundManagerTracks.Music:
                    ...
                    {
                        _mmSoundManager.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Music, newVolume);
                    }
                ...
                case MMSoundManager.MMSoundManagerTracks.Sfx:
                    ...
                    {
                        _mmSoundManager.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Sfx, newVolume);
                    }
                ...
                case MMSoundManager.MMSoundManagerTracks.UI:
                    ...
                    {
                        _mmSoundManager.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.UI, newVolume);
                    }
        ...
        public virtual void DrawColoredButton(string buttonLabel, Color buttonColor,
            MMSoundManager.MMSoundManagerTracks track, System.Action<MMSoundManager.MMSoundManagerTracks> action,
            GUIStyle styles)
        {

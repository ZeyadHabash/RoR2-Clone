...
namespace MoreMountains.Tools
{
    ...
    public struct MMPlaylistVolumeMultiplierEvent
    {
        ...
        public delegate void Delegate(int channel, float newVolumeMultiplier,
    ...
    public struct MMPlaylistPitchMultiplierEvent
    {
        ...
        public delegate void Delegate(int channel, float newPitchMultiplier,
    ...
    public class MMPlaylistSong
    {
        ...
        [MMHidden] public bool _initialized;
    ...
    public class MMPlaylist : MMMonoBehaviour
    {
        ...
        [MMReadOnly] public MMStateMachine<MMPlaylist.PlaylistStates> PlaylistState;
        ...
        protected virtual IEnumerator PlaySong(int index)
        {
            ...
            while (Songs[index].TargetAudioSource.isPlaying || (PlaylistState.CurrentState == PlaylistStates.Paused) ||
            ...
            bool applyVolumeMultiplierInstantly = false)
        {
            ...
            {
                Songs[CurrentlyPlayingIndex].TargetAudioSource.volume =
                    Songs[CurrentlyPlayingIndex].Volume.y * VolumeMultiplier;
            }
        }

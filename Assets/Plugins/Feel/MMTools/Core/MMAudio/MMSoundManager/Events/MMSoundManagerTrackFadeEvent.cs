...
namespace MoreMountains.Tools
{
    ...
    public struct MMSoundManagerTrackFadeEvent
    {
        ...
        public MMSoundManagerTrackFadeEvent(Modes mode, MMSoundManager.MMSoundManagerTracks track, float fadeDuration,
        ...
        public static void Trigger(Modes mode, MMSoundManager.MMSoundManagerTracks track, float fadeDuration,
            float finalVolume, MMTweenType fadeTween)
        {
            e.Mode = mode;
            e.Track = track;

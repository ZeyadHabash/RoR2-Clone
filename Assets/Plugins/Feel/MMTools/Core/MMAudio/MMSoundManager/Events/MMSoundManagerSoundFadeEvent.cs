...
namespace MoreMountains.Tools
{
    ...
    public struct MMSoundManagerSoundFadeEvent
    {
        ...
        public MMSoundManagerSoundFadeEvent(Modes mode, int soundID, float fadeDuration, float finalVolume,
        ...
        public static void Trigger(Modes mode, int soundID, float fadeDuration, float finalVolume,
            MMTweenType fadeTween)
        {
            e.Mode = mode;
            e.SoundID = soundID;

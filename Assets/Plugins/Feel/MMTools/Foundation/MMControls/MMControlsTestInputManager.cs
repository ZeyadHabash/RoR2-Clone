...
namespace MoreMountains.Tools
{
    ...
    public class MMControlsTestInputManager : MonoBehaviour, MMEventListener<MMSwipeEvent>
    {
        ...
        {
            Debug.LogFormat("Swipe at a " + swipeEvent.SwipeAngle + "° angle, and a length of " +
                            swipeEvent.SwipeLength + " length. Cardinal direction : " + swipeEvent.SwipeDirection);
            Debug.LogFormat("Swipe origin : " + swipeEvent.SwipeOrigin + ", swipe end : " +
                            swipeEvent.SwipeDestination);

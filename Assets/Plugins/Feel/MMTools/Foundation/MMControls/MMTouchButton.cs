...
namespace MoreMountains.Tools
{
        ...
        IPointerEnterHandler, ISubmitHandler
    {
        ...
        [Tooltip("the color to use when the button is disabled")] [MMCondition("DisabledChangeColor", true)]
        ...
        [Tooltip("the color to use when the button is pressed")] [MMCondition("PressedChangeColor", true)]
        ...
        [Tooltip("the color to use when the button is highlighted")] [MMCondition("HighlightedChangeColor", true)]

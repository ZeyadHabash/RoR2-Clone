...
namespace MoreMountains.Tools
{
    ...
    public class MMTouchJoystick : MMMonoBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler,
        IPointerUpHandler
    {
        ...
        [Tooltip(
            "Determines whether the horizontal axis of this stick should be enabled. If not, the stick will only move vertically.")]
        /// Is horizontal axis allowed
        public bool HorizontalAxisEnabled = true;

        /// Is vertical axis allowed
        [Tooltip(
            "Determines whether the vertical axis of this stick should be enabled. If not, the stick will only move horizontally.")]
        ...
        [Tooltip("the speed at which to interpolate opacity")] [MMCondition("InterpolateOpacity", true)]
        ...
        [Tooltip("the normalized value of the joystick")] [MMReadOnly]
        public Vector2 NormalizedValue;

        /// the magnitude of the stick's vector
        [Tooltip("the magnitude of the stick's vector")] [MMReadOnly]
        ...
        protected virtual void HandleOpacity()
        {
            ...
            {
                _canvasGroup.alpha = MMMaths.Lerp(_canvasGroup.alpha, _targetOpacity, InterpolateOpacitySpeed,

...
namespace MoreMountains.Tools
{
    ...
    public static class MMAchievementManager
    {
        ...
        public static void LoadSavedAchievements()
        {
            ...
            SerializedMMAchievementManager serializedMMAchievementManager =
                (SerializedMMAchievementManager)MMSaveLoadManager.Load(typeof(SerializedMMAchievementManager),
                    SaveFileName + _saveFileExtension, _saveFolderName);
        ...
        public static void FillSerializedMMAchievementManager(SerializedMMAchievementManager serializedAchievements)
        {
            ...
            {
                SerializedMMAchievement newAchievement = new SerializedMMAchievement(_achievements[i].AchievementID,
                    _achievements[i].UnlockedStatus, _achievements[i].ProgressCurrent);

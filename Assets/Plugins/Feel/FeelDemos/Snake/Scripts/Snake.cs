...
namespace MoreMountains.Feel
{
    ...
    public class Snake : MonoBehaviour
    {
        ...
        [Header("Debug")] [MMReadOnly] public int SnakePoints = 0;
        [MMReadOnly] public float _speed;
        [MMReadOnly] public float _speedMultiplier;
        [MMReadOnly] public float _lastFoodEatenAt = -100f;

    ...
    public class Barbarian : MonoBehaviour
    {
        ...
        protected virtual IEnumerator AttackCoroutine()
        {
            ...
            foreach (Vector3 destination in _targets)
            {
                ...
                MMTween.MoveTransform(this, this.transform, this.transform.position, destination, null, 0f,
                    intervalDuration, AttackCurve);
                _lookAtTarget = destination;
                yield return MMCoroutine.WaitFor(intervalDuration - enemyCounter * IntervalDecrement);
                enemyCounter++;
            }

            MMTween.MoveTransform(this, this.transform, this.transform.position, _initialPosition, null, 0f,
                intervalDuration, AttackCurve);
            _lookAtTarget = _initialLookAtTarget;
        }

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbacksEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox(
                    "The MMFeedbacks component got deprecated with the introduction of the MMF Player, in v3.0. " +
                    "The MMF Player improves performance, lets you keep runtime changes, and much more! And it works just like MMFeedbacks. " +
                    "With the release of v4.0, the MMF Player is now completely removed from Feel and phased out.",
                    MessageType.Warning);
            }
            ...
            Rect durationRect = new Rect(helpBoxRect.xMax - durationRectWidth, helpBoxRect.yMax + 6, durationRectWidth,
                17f);
            ...
            Rect directionRect = new Rect(helpBoxRect.xMax - directionRectWidth, helpBoxRect.yMax + 5,
        ...
        protected virtual void CopyFromMMFeedbacksToMMF_Player(MMF_Player newPlayer)
        {
            ...
            for (int i = 0; i < feedbacks.arraySize; i++)
            {
                ...
                if (newType == null)
                {
                    MMDebug.DebugLogInfo("<color=red>Couldn't find any MMF_Feedback matching " + oldTypeName +
                                         "</color>");
                }
                else
                {

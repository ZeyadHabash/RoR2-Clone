...
namespace MoreMountains.Feedbacks
{
    ...
    static class MMF_PlayerCopy
    {
        ...
        public static readonly Dictionary<MMF_Player, List<MMF_Feedback>> RuntimeChanges =
            new Dictionary<MMF_Player, List<MMF_Feedback>>();
        ...
        {
            foreach (MMF_Player player in MonoBehaviour.FindObjectsOfType<MMF_Player>(true)
                         .Where(p => p.KeepPlayModeChanges))
            {
        ...
        {
            foreach (MMF_Player player in MonoBehaviour.FindObjectsOfType<MMF_Player>(true)
                         .Where(MMF_PlayerCopy.RuntimeChanges.ContainsKey))
            {

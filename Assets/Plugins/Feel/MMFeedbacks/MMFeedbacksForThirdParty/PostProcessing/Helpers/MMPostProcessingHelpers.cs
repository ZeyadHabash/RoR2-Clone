...
namespace MoreMountains.FeedbacksForThirdParty
{
    public class MMPostProcessingHelpers : MonoBehaviour
    {
        ...
        public static void GetOrCreateVolume<T, U>(MMF_Player owner, string feedbackName)
            where T : PostProcessEffectSettings where U : MMShaker
        {
            ...
            if (volume == null)
            {
                GameObject postProcessingObject =
                    GameObject.Instantiate(Resources.Load<GameObject>("MMDefaultPostProcessingVolume"));
            ...
            if (!volume.sharedProfile.TryGetSettings(out effect))
            {
                ...
                additions += "Added a " + feedbackName + " post process effect to the " + volume.gameObject.name +
                             " Post Process Volume. ";
            }
            ...
            if (shaker == null)
            {
                ...
                additions += "Added a " + feedbackName + " Shaker to the " + volume.gameObject.name +
                             " Post Process Volume. ";
            }

...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMColorGradingShaker : MMShaker
    {
        ...
        [Tooltip("the gradient to use to animate the color filter over time")] [GradientUsage(true)]
    ...
    public struct MMColorGradingShakeEvent
    {
            ...
            bool restore = false)
        {
            OnEvent?.Invoke(shakePostExposure, remapPostExposureZero, remapPostExposureOne,
                ...
                duration, relativeValues, feedbacksIntensity, channelData, resetShakerValuesAfterShake,

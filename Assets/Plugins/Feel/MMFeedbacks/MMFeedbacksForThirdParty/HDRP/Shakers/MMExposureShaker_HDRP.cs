...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMExposureShaker_HDRP : MMShaker
    {
		...
		{
			float newValue =
 ShakeFloat(ShakeFixedExposure, RemapFixedExposureZero, RemapFixedExposureOne, RelativeIntensity, _initialFixedExposure);
		...
		public virtual void OnExposureShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity
 = false,
 ...
 false, bool restore = false)
    ...
    public struct MMExposureShakeEvent_HDRP
    {
        ...
        static public void Trigger(AnimationCurve fixedExposure, float duration, float remapMin, float remapMax,
            ...
            bool restore = false)
        {
            OnEvent?.Invoke(fixedExposure, duration, remapMin, remapMax, relativeFixedExposure, attenuation,
                channelData, resetShakerValuesAfterShake,

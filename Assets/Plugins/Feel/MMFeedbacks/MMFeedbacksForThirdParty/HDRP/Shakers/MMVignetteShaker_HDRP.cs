...
namespace MoreMountains.FeedbacksForThirdParty
{
 ...
 ShakeFloat(ShakeIntensity, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, _initialIntensity);
		...
		public virtual void OnVignetteShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity
 = false,
 ...
 false, bool restore = false,
			bool interpolateColor = false, AnimationCurve colorCurve = null, float remapColorZero =
 0f, float remapColorOne = 1f, Color targetColor = default(Color))
		{
    ...
    public struct MMVignetteShakeEvent_HDRP
    {
            ...
            float remapColorOne = 1f, Color targetColor = default(Color))
        {
            OnEvent?.Invoke(intensity, duration, remapMin, remapMax, relativeIntensity, attenuation, channelData,
                ...
                resetTargetValuesAfterShake, forwardDirection, timescaleMode, stop, restore, interpolateColor,

...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMF_NVClip : MMF_Feedback
    {
        ...
        {
            get { return MMFeedbacksInspectorColors.HapticsColor; }
        }
        ...
        public override string RequiresSetupText
        {
            get
            {
                return "This feedback requires that a Clip be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        [Tooltip(
            "the minimum frequency shift at which this clip should play (frequency shift will be randomized between MinFrequencyShift and MaxFrequencyShift)")]
        [Range(-1f, 1f)]
        ...
        [Tooltip(
            "the maximum frequency shift at which this clip should play (frequency shift will be randomized between MinFrequencyShift and MaxFrequencyShift)")]
        [Range(-1f, 1f)]

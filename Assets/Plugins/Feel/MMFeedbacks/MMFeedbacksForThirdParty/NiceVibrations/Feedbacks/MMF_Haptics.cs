...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    [FeedbackHelp(
        "This feedback has been deprecated, and is just here to avoid errors in case you were to update from an old version. Use any of the new haptic feedbacks instead.")]

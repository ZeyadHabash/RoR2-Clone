...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMF_MotionBlur_URP : MMF_Feedback
    {
        ...
        [Tooltip("the value to which to remap the curve's zero to")] [Range(0f, 1f)]
        public float RemapIntensityZero = 0f;

        /// the value to which to remap the curve's one to
        [Tooltip("the value to which to remap the curve's one to")] [Range(0f, 1f)]
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMMotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,

...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMF_ChromaticAberration_URP : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMChromaticAberrationShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero,
        ...
        public override void AutomaticShakerSetup()
        {
            ...
            MMURPHelpers.GetOrCreateVolume<ChromaticAberration, MMChromaticAberrationShaker_URP>(Owner,

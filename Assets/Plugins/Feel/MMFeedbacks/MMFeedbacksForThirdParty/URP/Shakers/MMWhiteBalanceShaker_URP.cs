...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMWhiteBalanceShaker_URP : MMShaker
    {
        ...
        {
            float newTemperature = ShakeFloat(ShakeTemperature, RemapTemperatureZero, RemapTemperatureOne,
        ...
        public virtual void OnWhiteBalanceShakeEvent(AnimationCurve temperature, float duration,
            float remapTemperatureMin, float remapTemperatureMax,

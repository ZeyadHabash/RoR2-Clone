...
namespace MoreMountains.FeedbacksForThirdParty
{
 ...
 Mathf.LerpUnclamped(_startFieldOfView, _targetFieldOfView, ZoomTween.Evaluate(t));
#elif MM_CINEMACHINE3
                _freeLookCamera.Lens.FieldOfView =
                    Mathf.LerpUnclamped(_startFieldOfView, _targetFieldOfView, ZoomTween.Evaluate(t));
#endif
            }
            else
        ...
        public virtual void OnCameraZoomEvent(MMCameraZoomModes mode, float newFieldOfView, float transitionDuration,
            float duration,
            MMChannelData channelData, bool useUnscaledTime, bool stop = false, bool relative = false,
            bool restore = false, MMTweenType tweenType = null)
        {

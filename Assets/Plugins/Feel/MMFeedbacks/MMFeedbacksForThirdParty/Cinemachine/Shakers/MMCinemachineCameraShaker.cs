...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMCinemachineCameraShaker : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            _perlin =
                _virtualCamera.GetCinemachineComponent(CinemachineCore.Stage.Noise) as
 ...
 Mathf.Lerp(_perlin.m_FrequencyGain, _targetFrequency, GetDeltaTime() * LerpSpeed);
			}
#elif MM_CINEMACHINE3
            if (_perlin != null)
            {
        ...
        {
            MMCameraShakeEvent.Trigger(TestDuration, TestAmplitude, TestFrequency, 0f, 0f, 0f, false,
                new MMChannelData(ChannelMode, Channel, MMChannelDefinition));
        }
    }
}
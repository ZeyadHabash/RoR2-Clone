...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ImageAlpha : MMF_Feedback
    {
        ...
        {
            get { return BoundImage != null ? BoundImage.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a BoundImage be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        [Tooltip("the alpha to move to in instant mode")] [MMFEnumCondition("Mode", (int)Modes.Instant)]
        ...
        [Tooltip("the value to which the curve's 0 should be remapped")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
        public float CurveRemapZero = 0f;

        /// the value to which the curve's 1 should be remapped
        [Tooltip("the value to which the curve's 1 should be remapped")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]

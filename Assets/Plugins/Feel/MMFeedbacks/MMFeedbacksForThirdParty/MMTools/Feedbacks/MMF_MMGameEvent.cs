...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_MMGameEvent : MMF_Feedback
    {
        ...
        {
            get { return MMGameEventName; }
        }

        public override string RequiresSetupText
        {
            get { return "This feedback requires that you specify a MMGameEventName below."; }
        }
#endif
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMGameEvent.Trigger(MMGameEventName, IntParameter, Vector2Parameter, Vector3Parameter, BoolParameter,
                StringParameter);
        }
    }
}
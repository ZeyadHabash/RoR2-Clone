...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_FloatController : MMF_Feedback
    {
        ...
        {
            return (TargetFloatController == null);
        }

        public override string RequiredTargetText
        {
            get { return TargetFloatController != null ? TargetFloatController.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a TargetFloatController be set to be able to work properly. You can set one below.";
            }
        }
#endif

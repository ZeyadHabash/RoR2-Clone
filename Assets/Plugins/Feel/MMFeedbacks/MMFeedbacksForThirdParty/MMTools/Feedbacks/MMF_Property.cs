...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Property : MMF_Feedback
    {
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a Target be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        protected virtual void SetValues(float time, float intensityMultiplier, float remapZero, float remapOne,
            bool applyRelative)
        {

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_LoadScene : MMF_Feedback
    {
        ...
        {
            get { return DestinationSceneName; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that you specify a DestinationSceneName below. Make sure you also add that destination scene to your Build Settings.";
            }
        }
#endif

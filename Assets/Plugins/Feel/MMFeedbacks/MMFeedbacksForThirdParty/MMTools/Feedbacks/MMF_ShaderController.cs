...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ShaderController : MMF_Feedback
    {
        ...
        {
            return (TargetShaderController == null);
        }

        public override string RequiredTargetText
        {
            get { return TargetShaderController != null ? TargetShaderController.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a TargetShaderController be set to be able to work properly. You can set one below.";
            }
        }
#endif

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMSpringClampSettings
    {
        ...
        [Tooltip("the value below which this spring can't go")] [MMCondition("ClampMin", true)]
        ...
        [Tooltip("whether or not the spring should bounce off the min value or not")] [MMCondition("ClampMin", true)]
        ...
        [Tooltip("the value above which this spring can't go")] [MMCondition("ClampMax", true)]
        ...
        [Tooltip("whether or not the spring should bounce off the max value or not")] [MMCondition("ClampMax", true)]

...
namespace MoreMountains.Feedbacks
{
    ...
    public struct MMSpringVector4Event
    {
        ...
        public static void Trigger(SpringCommands command, MMSpringComponentBase targetSpring,
            ...
            bool overrideDamping = false, Vector4 newDamping = default, bool overrideFrequency = false,
            Vector4 newFrequency = default)
        {
    ...
    /// </summary>
    public abstract class MMSpringVector4<T> : MMSpringComponentBase, MMEventListener<MMSpringVector4Event>
        where T : Component
    {
        [MMInspectorGroup("Target", true, 17)] public T Target;
        ...
        [MMInspectorGroup("Spring Settings", true, 18)] [Header("SpringVector4")]
        ...
        [MMInspectorButtonBar(
            new string[] { "MoveTo", "MoveToAdditive", "MoveToSubtractive", "MoveToRandom", "MoveToInstant" },
            new string[]
            {
                "TestMoveTo", "TestMoveToAdditive", "TestMoveToSubtractive", "TestMoveToRandom", "TestMoveToInstant"
            },
        ...
        public override bool LowVelocity =>
            (Mathf.Abs(SpringVector4.SpringX.Velocity) + Mathf.Abs(SpringVector4.SpringY.Velocity) +
             Mathf.Abs(SpringVector4.SpringZ.Velocity) + Mathf.Abs(SpringVector4.SpringW.Velocity)) <
        ...
        {
            bool eventMatch = springEvent.ChannelData != null &&
                              MMChannel.Match(springEvent.ChannelData, ChannelMode, Channel, MMChannelDefinition);

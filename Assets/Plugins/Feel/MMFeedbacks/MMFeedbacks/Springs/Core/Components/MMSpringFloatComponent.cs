...
namespace MoreMountains.Feedbacks
{
    ...
    public struct MMSpringFloatEvent
    {
        ...
        public static void Trigger(SpringCommands command, MMSpringComponentBase targetSpring,
            ...
            float moveToValue = 1f, float bumpAmount = 1f, Vector2 moveToRandomValue = default,
            Vector2 bumpAmountRandomValue = default,
            bool overrideDamping = false, float newDamping = 0.8f, bool overrideFrequency = false,
    ...
    /// </summary>
    public abstract class MMSpringFloatComponent<T> : MMSpringComponentBase, MMEventListener<MMSpringFloatEvent>
        where T : Component
    {

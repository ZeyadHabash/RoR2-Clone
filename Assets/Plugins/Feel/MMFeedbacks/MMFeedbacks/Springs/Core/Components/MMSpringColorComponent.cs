...
namespace MoreMountains.Feedbacks
{
    ...
    public struct MMSpringColorEvent
    {
        ...
        public static void Trigger(SpringCommands command, MMSpringComponentBase targetSpring,
            ...
            bool overrideDamping = false, float newDamping = default, bool overrideFrequency = false,
            float newFrequency = default)
        {
    ...
    /// </summary>
    public abstract class MMSpringColorComponent<T> : MMSpringComponentBase, MMEventListener<MMSpringColorEvent>
        where T : Component
    {
        ...
        public override bool LowVelocity => (Mathf.Abs(ColorSpring.Velocity.r) + Mathf.Abs(ColorSpring.Velocity.g) +
                                             Mathf.Abs(ColorSpring.Velocity.b) + Mathf.Abs(ColorSpring.Velocity.a) +
                                             Mathf.Abs(ColorSpring.ColorSpring.Velocity)) < _velocityLowThreshold;

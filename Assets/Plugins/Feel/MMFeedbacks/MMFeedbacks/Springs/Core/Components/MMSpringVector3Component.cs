...
namespace MoreMountains.Feedbacks
{
    ...
    public struct MMSpringVector3Event
    {
        ...
        public static void Trigger(SpringCommands command, MMSpringComponentBase targetSpring,
            ...
            bool overrideDamping = false, Vector3 newDamping = default, bool overrideFrequency = false,
            Vector3 newFrequency = default)
        {
    ...
    /// </summary>
    public abstract class MMSpringVector3Component<T> : MMSpringComponentBase, MMEventListener<MMSpringVector3Event>
        where T : Component
    {
        ...
        [MMInspectorGroup("Spring Settings", true, 18)] [Header("SpringVector3")]
        ...
        public override bool LowVelocity =>
            (Mathf.Abs(SpringVector3.Velocity.x) + Mathf.Abs(SpringVector3.Velocity.y) +
             Mathf.Abs(SpringVector3.Velocity.z)) < _velocityLowThreshold;

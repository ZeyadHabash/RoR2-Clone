...
namespace MoreMountains.Feedbacks
{
    ...
    public struct MMSpringVector2Event
    {
        ...
        public static void Trigger(SpringCommands command, MMSpringComponentBase targetSpring,
            ...
            bool overrideDamping = false, Vector2 newDamping = default, bool overrideFrequency = false,
            Vector2 newFrequency = default)
        {
    ...
    /// </summary>
    public abstract class MMSpringVector2Component<T> : MMSpringComponentBase, MMEventListener<MMSpringVector2Event>
        where T : Component
    {
        ...
        [MMInspectorGroup("Spring Settings", true, 18)] [Header("SpringVector2")]
        ...
        public override bool LowVelocity =>
            (Mathf.Abs(SpringVector2.Velocity.x) + Mathf.Abs(SpringVector2.Velocity.y)) < _velocityLowThreshold;

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMSpringFloat : MMSpringDefinition<float>
    {
        ...
        {
            get { return _returnCurrentValue; }
            set
            {
        ...
        [MMHidden] public bool UnifiedSpring = false;
        [MMHidden] public float CurrentValueDisplay;
        [MMHidden] public float TargetValueDisplay;
        [MMHidden] public float VelocityDisplay;

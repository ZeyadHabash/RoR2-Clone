...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_AnimationCrossfade : MMF_Feedback
    {
        ...
        protected virtual void CrossFade(Animator targetAnimator)
        {
            ...
            {
                case Modes.Seconds:
                    targetAnimator.CrossFadeInFixedTime(_stateHashName, TransitionDuration, Layer, TimeOffset,
                        NormalizedTransitionTime);
                    break;
                case Modes.Normalized:
                    targetAnimator.CrossFade(_stateHashName, NormalizedTransitionDuration, Layer, NormalizedTimeOffset,
                        NormalizedTransitionTime);
                    break;
            }
        }

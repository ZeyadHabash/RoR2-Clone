...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ShaderGlobal : MMF_Feedback
    {
        ...
        [MMFEnumCondition("Mode", (int)Modes.SetGlobalColor, (int)Modes.SetGlobalFloat, (int)Modes.SetGlobalInt,
            (int)Modes.SetGlobalMatrix, (int)Modes.SetGlobalTexture, (int)Modes.SetGlobalVector)]
        ...
        [Tooltip("a global color property for all shaders")] [MMFEnumCondition("Mode", (int)Modes.SetGlobalColor)]
        public Color GlobalColor = Color.yellow;

        /// a global float property for all shaders
        [Tooltip("a global float property for all shaders")] [MMFEnumCondition("Mode", (int)Modes.SetGlobalFloat)]
        public float GlobalFloat = 1f;

        /// a global int property for all shaders
        [Tooltip("a global int property for all shaders")] [MMFEnumCondition("Mode", (int)Modes.SetGlobalInt)]
        public int GlobalInt = 1;

        /// a global matrix property for all shaders
        [Tooltip("a global matrix property for all shaders")] [MMFEnumCondition("Mode", (int)Modes.SetGlobalMatrix)]
        public Matrix4x4 GlobalMatrix = Matrix4x4.identity;

        /// a global texture property for all shaders
        [Tooltip("a global texture property for all shaders")] [MMFEnumCondition("Mode", (int)Modes.SetGlobalTexture)]
        public RenderTexture GlobalTexture;

        /// a global vector property for all shaders
        [Tooltip("a global vector property for all shaders")] [MMFEnumCondition("Mode", (int)Modes.SetGlobalVector)]

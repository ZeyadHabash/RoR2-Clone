...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Feedbacks : MMF_Feedback
    {
        ...
        {
            get { return MMFeedbacksInspectorColors.FeedbacksColor; }
        }
        ...
        [MMFEnumCondition("Mode", (int)Modes.PlayFeedbacksInArea)] [Tooltip("whether or not to use a range")]
        public bool OnlyTriggerPlayersInRange = false;

        /// the range of the event, in units
        [MMFEnumCondition("Mode", (int)Modes.PlayFeedbacksInArea)] [Tooltip("the range of the event, in units")]
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            {
                MMFeedbacksShakeEvent.Trigger(ChannelData, OnlyTriggerPlayersInRange, EventRange,
                    EventOriginTransform.position);
            }

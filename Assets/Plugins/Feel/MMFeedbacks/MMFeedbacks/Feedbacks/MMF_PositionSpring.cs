...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_PositionSpring : MMF_Feedback
    {
        ...
        {
            get { return AnimatePositionTarget != null ? AnimatePositionTarget.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that an AnimatePositionTarget be set to be able to work properly. You can set one below.";
            }
        }

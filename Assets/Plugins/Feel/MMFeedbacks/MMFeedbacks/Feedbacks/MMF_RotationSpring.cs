...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_RotationSpring : MMF_Feedback
    {
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that an AnimateRotationTarget be set to be able to work properly. You can set one below.";
            }
        }
        ...
        {
            get { return ApplyTimeMultiplier(DeclaredDuration); }
        ...
        protected virtual bool LowVelocity =>
            (Mathf.Abs(_velocity.x) + Mathf.Abs(_velocity.y) + Mathf.Abs(_velocity.z)) < _velocityLowThreshold;
        ...
        {
            MMMaths.Spring(ref _currentValue.x, _targetValue.x, ref _velocity.x, DampingX, FrequencyX,
                FeedbackDeltaTime);
            MMMaths.Spring(ref _currentValue.y, _targetValue.y, ref _velocity.y, DampingY, FrequencyY,
                FeedbackDeltaTime);
            MMMaths.Spring(ref _currentValue.z, _targetValue.z, ref _velocity.z, DampingZ, FrequencyZ,
                FeedbackDeltaTime);
            ApplyValue();
        }

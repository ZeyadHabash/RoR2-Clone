...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Image : MMF_Feedback
    {
        ...
        [Tooltip("how long the Image should change over time")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
        ...
        [Tooltip("the colors to apply to the Image over time")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
        ...
        [Tooltip("whether or not that Image should be turned off on start")] [FormerlySerializedAs("StartsOff")]

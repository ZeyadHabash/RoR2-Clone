...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SetParent : MMF_Feedback
    {
        ...
        {
            return (ObjectToParent == null);
        }

        public override string RequiredTargetText
        {
            get { return ObjectToParent != null ? ObjectToParent.name : ""; }
        }

        public override string RequiresSetupText
        {
            get { return "This feedback requires an ObjectToParent, that will be reparented to NewParent"; }
        }
#endif

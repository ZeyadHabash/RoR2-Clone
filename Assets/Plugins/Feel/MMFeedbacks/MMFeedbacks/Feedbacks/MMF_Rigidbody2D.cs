...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Rigidbody2D : MMF_Feedback
    {
        ...
        {
            return (TargetRigidbody2D == null);
        }

        public override string RequiredTargetText
        {
            get { return TargetRigidbody2D != null ? TargetRigidbody2D.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a TargetRigidbody2D be set to be able to work properly. You can set one below.";
            }
        }
#endif

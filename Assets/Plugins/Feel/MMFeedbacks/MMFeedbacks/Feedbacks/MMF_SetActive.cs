...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SetActive : MMF_Feedback
    {
        ...
        [Tooltip("how to change the state on skip")] [MMFCondition("SetStateOnSkip", true)]
        ...
        [Tooltip("how to change the state on player complete")] [MMFCondition("SetStateOnPlayerComplete", true)]

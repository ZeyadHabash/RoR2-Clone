...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_LookAt : MMF_Feedback
    {
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "In Direct mode, this feedback requires that a DirectTargetTransform be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        [Tooltip("whether or not to reset shaker values after shake")] [MMFEnumCondition("Mode", (int)Modes.Event)]
        ...
        protected virtual void ApplyRotation(float percent)
        {
            ...
            TransformToRotate.transform.rotation =
                Quaternion.SlerpUnclamped(_initialDirectTargetTransformRotation, _newRotation, percent);
        }

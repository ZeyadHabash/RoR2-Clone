...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Animation : MMF_Feedback
    {
        ...
        {
            get { return MMFeedbacksInspectorColors.AnimationColor; }
        }

        public override bool EvaluateRequiresSetup()
        {
            return (BoundAnimator == null);
        }

        public override string RequiredTargetText
        {
            get { return BoundAnimator != null ? BoundAnimator.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a BoundAnimator be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        /// the int parameter to turn true when the feedback gets played
        [Tooltip("the int parameter to turn true when the feedback gets played")]
        [MMFEnumCondition("IntValueMode", (int)ValueModes.Constant, (int)ValueModes.Random,
        ...
        [Tooltip("the index of the layer to target when changing layer weights")] [MMFCondition("SetLayerWeight", true)]
        public int TargetLayerIndex = 1;

        /// the new weight to set on the target animator layer
        [Tooltip("the new weight to set on the target animator layer")] [MMFCondition("SetLayerWeight", true)]

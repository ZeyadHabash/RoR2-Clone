...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Rotation : MMF_Feedback
    {
        ...
        {
            get { return AnimateRotationTarget != null ? AnimateRotationTarget.name : ""; }
        }
        ...
        [Tooltip("how the x part of the rotation should animate over time, in degrees")] [MMFCondition("AnimateX")]
        ...
        [Tooltip("how the y part of the rotation should animate over time, in degrees")] [MMFCondition("AnimateY")]
        ...
        [Tooltip("how the z part of the rotation should animate over time, in degrees")] [MMFCondition("AnimateZ")]
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            if (Active || Owner.AutoPlayOnEnable)
            {
                if ((Mode == Modes.Absolute) || (Mode == Modes.Additive))
                {
                    ...
                    ClearCoroutine();
                    _coroutine = Owner.StartCoroutine(AnimateRotation(AnimateRotationTarget, Vector3.zero,
                        FeedbackDuration, AnimateRotationTweenX, AnimateRotationTweenY, AnimateRotationTweenZ,
        ...
        protected virtual void ApplyRotation(Transform targetTransform, float remapZero, float remapOne,
            MMTweenType curveX, MMTweenType curveY, MMTweenType curveZ, float percent)
        {

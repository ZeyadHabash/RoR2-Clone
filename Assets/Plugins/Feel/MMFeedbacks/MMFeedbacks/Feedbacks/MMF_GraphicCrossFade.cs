...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_GraphicCrossFade : MMF_Feedback
    {
        ...
        {
            get { return TargetGraphic != null ? TargetGraphic.name : ""; }
        }
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            switch (Mode)
            {
                case Modes.Alpha:
                    ...
                    TargetGraphic.CrossFadeAlpha(NormalPlayDirection ? TargetAlpha : _initialColor.a, Duration,
                        ignoreTimeScale);
                    break;
                case Modes.Color:
                    TargetGraphic.CrossFadeColor(NormalPlayDirection ? TargetColor : _initialColor, Duration,
                        ignoreTimeScale, UseAlpha);
                    break;
            }
        }

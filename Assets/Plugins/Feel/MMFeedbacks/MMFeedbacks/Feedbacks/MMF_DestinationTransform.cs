...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_DestinationTransform : MMF_Feedback
    {
        ...
        {
            get { return TargetTransform != null ? TargetTransform.name : ""; }
        }
        ...
        protected virtual void ChangeTransformValues(float percent)
        {
            ...
            _newPosition =
                Vector3.LerpUnclamped(_pointAPosition, _pointBPosition, _animationTweenType.Evaluate(percent));

            _animationTweenType = SeparateRotationCurve ? AnimateRotationTween : GlobalAnimationTween;
            _newRotation =
                Quaternion.LerpUnclamped(_pointARotation, _pointBRotation, _animationTweenType.Evaluate(percent));

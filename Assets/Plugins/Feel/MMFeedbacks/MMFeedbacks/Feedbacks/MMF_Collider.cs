...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Collider : MMF_Feedback
    {
        ...
        {
            get { return TargetCollider != null ? TargetCollider.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a TargetCollider be set to be able to work properly. You can set one below.";
            }
        }
#endif

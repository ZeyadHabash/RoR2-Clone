...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_AudioSource : MMF_Feedback
    {
        ...
        {
            get { return TargetAudioSource != null ? TargetAudioSource.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a TargetAudioSource be set to be able to work properly. You can set one below.";
            }
        }
#endif

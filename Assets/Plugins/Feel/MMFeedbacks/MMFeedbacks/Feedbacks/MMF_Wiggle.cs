...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Wiggle : MMF_Feedback
    {
        ...
        {
            return (TargetWiggle == null);
        }

        public override string RequiredTargetText
        {
            get { return TargetWiggle != null ? TargetWiggle.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a TargetWiggle be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        public override float FeedbackDuration
        {
            get
            {
                return Mathf.Max(ApplyTimeMultiplier(WigglePositionDuration),
                    ApplyTimeMultiplier(WiggleRotationDuration), ApplyTimeMultiplier(WiggleScaleDuration));
            }
            set
            {

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Particles : MMF_Feedback
    {
        ...
        {
            get { return BoundParticleSystem != null ? BoundParticleSystem.name : ""; }
        }
        ...
        [Tooltip("in Emit mode, the amount of particles per emit")] [MMFEnumCondition("Mode", (int)Modes.Emit)]

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ScaleShake : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            {
                MMScaleShakeEvent.Trigger(Duration, ShakeSpeed, ShakeRange, ShakeMainDirection, RandomizeDirection,
            ...
            {
                TargetShaker?.OnMMScaleShakeEvent(Duration, ShakeSpeed, ShakeRange, ShakeMainDirection,

        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            switch (Mode)
            {
                case Modes.PlayFeedbacks:
                    foreach (MMF_Player player in TargetPlayers)
                    {
                        player.PlayFeedbacks(position, feedbacksIntensity);
                    }
                ...
                case Modes.PlayFeedbacksInReverse:
                    foreach (MMF_Player player in TargetPlayers)
                    {
                        player.PlayFeedbacksInReverse(position, feedbacksIntensity);
                    }
                ...
                case Modes.PlayFeedbacksOnlyIfReversed:
                    foreach (MMF_Player player in TargetPlayers)
                    {
                        player.PlayFeedbacksOnlyIfReversed(position, feedbacksIntensity);
                    }
                ...
                case Modes.PlayFeedbacksOnlyIfNormalDirection:
                    foreach (MMF_Player player in TargetPlayers)
                    {
                        player.PlayFeedbacksOnlyIfNormalDirection(position, feedbacksIntensity);
                    }

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_AudioMixerSnapshotTransition : MMF_Feedback
    {
        ...
        {
            return ((TargetSnapshot == null) || (OriginalSnapshot == null));
        }
        ...
        public override string RequiredTargetText
        {
            ...
            {
                return ((TargetSnapshot != null) && (OriginalSnapshot != null))
                    ? TargetSnapshot.name + " to " + OriginalSnapshot.name
                    : "";
            }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that both a OriginalSnapshot and TargetSnapshot be set to be able to work properly. You can set these below.";
            }
        }
#endif

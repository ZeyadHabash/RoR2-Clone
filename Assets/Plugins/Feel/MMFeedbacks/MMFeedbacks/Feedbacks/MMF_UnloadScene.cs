...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_UnloadScene : MMF_Feedback
    {
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that you specify a SceneName below. Make sure you also add that destination scene to your Build Settings.";
            }
        }
#endif
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            else
            {
                ...
                {
                    Debug.LogWarning(
                        "Unload Scene Feedback : you're trying to unload a scene that hasn't been loaded.");
                }
            }
        }
    }

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ParticlesInstantiation : MMF_Feedback
    {
        ...
        {
            return (ParticlesPrefab == null);
        }

        public override string RequiredTargetText
        {
            get { return ParticlesPrefab != null ? ParticlesPrefab.name : ""; }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a ParticlesPrefab be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        [Tooltip("the initial and planned size of this object pool")] [MMFEnumCondition("Mode", (int)Modes.Pool)]
            ...
            if (RandomParticlePrefabs.Count > 0)
            {
                ...
                else
                {
                    ...
                    _instantiatedParticleSystem =
                        GameObject.Instantiate(RandomParticlePrefabs[random], newParent) as ParticleSystem;
                    if (newParent == null)
                    {
                        SceneManager.MoveGameObjectToScene(_instantiatedParticleSystem.gameObject,

    ...
    public class MMF_TextureOffset : MMF_Feedback
    {
        ...
        protected override void CustomInitialization(MMF_Player owner)
        {
            ...
            if (UseMaterialPropertyBlocks)
            {
                ...
                _propertyBlockVector.x =
                    TargetRenderer.sharedMaterials[MaterialIndex].GetVector(MaterialPropertyName).x;
                _propertyBlockVector.y =
                    TargetRenderer.sharedMaterials[MaterialIndex].GetVector(MaterialPropertyName).y;

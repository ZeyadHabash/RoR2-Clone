...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_MaterialSetProperty : MMF_Feedback
    {
        ...
        {
            get { return TargetRenderer != null ? TargetRenderer.name : ""; }
        }
        ...
        [Tooltip("the duration of the interpolation")] [MMFCondition("InterpolateValue", true)]
        public float Duration = 2f;

        /// the curve over which to interpolate the value
        [Tooltip("the curve over which to interpolate the value")] [MMFCondition("InterpolateValue", true)]
        ...
        {
            get { return (InterpolateValue) ? ApplyTimeMultiplier(Duration) : 0f; }
            set
            {
                if (InterpolateValue)
                {

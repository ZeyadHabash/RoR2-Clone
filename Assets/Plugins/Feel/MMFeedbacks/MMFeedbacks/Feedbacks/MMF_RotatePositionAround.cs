...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_RotatePositionAround : MMF_Feedback
    {
        ...
        {
            return (AnimateRotationTarget == null);
        }
        ...
        public override string RequiredTargetText
        {
            get
            {
                return ((AnimateRotationTarget != null) || (AnimateRotationCenter != null))
                    ? AnimateRotationTarget.name
                    : "";
            }
        }
        ...
        public override string RequiresSetupText
        {
            ...
            {
                return
                    "This feedback requires that a AnimatePositionTarget and a AnimateRotationCenter be set to be able to work properly. You can set one below.";
            }
        }
#endif
        ...
        [Tooltip("how the x part of the movement should animate over time, in degrees")] [MMCondition("AnimateX", true)]
        ...
        [Tooltip("how the y part of the rotation should animate over time, in degrees")] [MMCondition("AnimateY", true)]
        ...
        [Tooltip("how the z part of the rotation should animate over time, in degrees")] [MMCondition("AnimateZ", true)]
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            if (Active || Owner.AutoPlayOnEnable)
            {
                ...
                ClearCoroutine();
                _coroutine = Owner.StartCoroutine(AnimateRotation(AnimateRotationTarget, Vector3.zero, FeedbackDuration,
                    AnimateRotationX, AnimateRotationY, AnimateRotationZ, RemapCurveZero * intensityMultiplier,
            ...
            AnimationCurve curveX, AnimationCurve curveY, AnimationCurve curveZ, float percent)
        {
            ...
            targetTransform.position = MMMaths.RotatePointAroundPivot(targetTransform.position,
                AnimateRotationCenter.position, _rotationAngles);
        }

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_InstantiateObject : MMF_Feedback
    {
        ...
        {
            get { return GameObjectToInstantiate != null ? GameObjectToInstantiate.name : ""; }
        }
        ...
        [Tooltip("the position offset at which to instantiate the object")] [FormerlySerializedAs("VfxPositionOffset")]
        ...
        [Tooltip("the minimum value we'll randomize our position with")] [MMFCondition("RandomizePosition", true)]
        public Vector3 RandomizedPositionMin = Vector3.zero;

        /// the maximum value we'll randomize our position with
        [Tooltip("the maximum value we'll randomize our position with")] [MMFCondition("RandomizePosition", true)]
        ...
        [Tooltip("the transform the pool of objects will be parented to")] [MMFCondition("CreateObjectPool", true)]

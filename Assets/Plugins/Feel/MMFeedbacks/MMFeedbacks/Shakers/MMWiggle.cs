...
namespace MoreMountains.Feedbacks
{
    ...
    public class WiggleProperties
    {
        ...
        [Tooltip("the maximum time left")] public float LimitedTimeTotal;
        ...
        [Tooltip("the actual time left")] [MMFReadOnly]
    ...
    public class MMWiggle : MonoBehaviour
    {
        ...
        protected virtual void WiggleValue(ref WiggleProperties property,
            ref InternalWiggleProperties internalProperties, float duration)
        {
            ...
            ref InternalWiggleProperties internalProperties)
        {
            ...
            internalProperties.randomFrequency =
                UnityEngine.Random.Range(properties.FrequencyMin, properties.FrequencyMax);
            ...
            RandomizeVector3(ref internalProperties.randomNoiseShift, properties.NoiseShiftMin,
                properties.NoiseShiftMax);
            RandomizeVector3(ref internalProperties.remapZero, properties.RemapCurveZeroMin,
                properties.RemapCurveZeroMax);
            ...
            {
                internalProperties.randomAmplitude =
                    internalProperties.randomAmplitude.normalized * properties.ForcedVectorLength;
            }

            internalProperties.newValue = DetermineNewValue(properties, internalProperties.newValue,
                internalProperties.initialValue, ref internalProperties.startValue,
                ref internalProperties.randomAmplitude, ref internalProperties.randomFrequency,
                ref internalProperties.pauseDuration, true);
        }
            ...
            WiggleProperties properties)
        {
            ...
            internalProperties.newValue.x =
                (Mathf.PerlinNoise(internalProperties.randomNoiseFrequency.x * internalProperties.noiseElapsedTime,
                    internalProperties.randomNoiseShift.x) * 2.0f - 1.0f) * internalProperties.randomAmplitude.x;
            internalProperties.newValue.y =
                (Mathf.PerlinNoise(internalProperties.randomNoiseFrequency.y * internalProperties.noiseElapsedTime,
                    internalProperties.randomNoiseShift.y) * 2.0f - 1.0f) * internalProperties.randomAmplitude.y;
            internalProperties.newValue.z =
                (Mathf.PerlinNoise(internalProperties.randomNoiseFrequency.z * internalProperties.noiseElapsedTime,
                    internalProperties.randomNoiseShift.z) * 2.0f - 1.0f) * internalProperties.randomAmplitude.z;
            ...
            WiggleProperties properties)
        {
            ...
            if (internalProperties.timeSinceLastPause < internalProperties.pauseDuration)
            {
                ...
                EvaluateCurve(properties.Curve, curveProgress, internalProperties.remapZero,
                    internalProperties.remapOne, ref internalProperties.newValue, properties);
        ...
        protected virtual void EvaluateCurve(AnimationCurve curve, float percent, Vector3 remapMin, Vector3 remapMax,
            ref Vector3 returnValue, WiggleProperties properties)
        {
            ...
            switch (properties.WiggleType)
            {
                case WiggleTypes.PingPong:
                    ...
                    else
                    {
                        ...
                        {
                            startValue = newValue;
                            newValue = (newValue == properties.AmplitudeMin)
                                ? properties.AmplitudeMax * ApplyFalloff(properties)
                                : properties.AmplitudeMin;
                        }
                    }

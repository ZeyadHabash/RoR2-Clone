...
namespace MoreMountains.Feedbacks
{
    ...
    public abstract class MMFeedback : MonoBehaviour
    {
        ...
        public virtual bool InCooldown
        {
            get
            {
                return (Timing.CooldownDuration > 0f) && (FeedbackTime - _lastPlayTimestamp < Timing.CooldownDuration);
            }
        }
        ...
        public float TotalDuration
        {
            get
            {
                ...
                if (Timing.NumberOfRepeats > 0)
                {
                    ...
                    totalTime += (Timing.NumberOfRepeats * FeedbackDuration) +
                                 (Timing.NumberOfRepeats * delayBetweenRepeats);
                }

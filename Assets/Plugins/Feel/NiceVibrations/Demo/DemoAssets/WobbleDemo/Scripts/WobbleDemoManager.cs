...
namespace Lofelt.NiceVibrations
{
    public class WobbleDemoManager : DemoManager
    {
        ...
        protected virtual void Start()
        {
            ...
            float centerH = (ContentZone.rect.width - (Padding * 2) - (horizontal * PrefabSize.x) -
                             (horizontal - 1) * Margin) / 2f;
            float centerV = (ContentZone.rect.height - (Padding * 2) - (vertical * PrefabSize.x) -
                             (vertical - 1) * Margin) / 2f;

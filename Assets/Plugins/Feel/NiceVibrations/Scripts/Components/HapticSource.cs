...
namespace Lofelt.NiceVibrations
{
    ...
    public class HapticSource : MonoBehaviour
    {
        ...
        [SerializeField] HapticPatterns.PresetType _fallbackPreset = HapticPatterns.PresetType.None;
        ...
        [SerializeField] float _level = 1.0f;
        ...
        [SerializeField] float _frequencyShift = 0.0f;
        ...
        static HapticSource()
        {
            ...
            HapticController.LoadedClipChanged += () => { loadedHapticSource = null; };
            HapticController.PlaybackStarted += () => { lastPlayedHapticSource = null; };
        }

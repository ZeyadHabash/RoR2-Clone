...
namespace Lofelt.NiceVibrations
{
    ...
    public struct GamepadRumble
    {
        ...
        /// index
        /// </summary>
        [SerializeField] public int[] durationsMs;

        /// <summary>
        /// The total duration of the GamepadRumble, in milliseconds
        /// </summary>
        [SerializeField] public int totalDurationMs;

        /// <summary>
        /// The motor speeds of the low frequency motor
        /// </summary>
        [SerializeField] public float[] lowFrequencyMotorSpeeds;

        /// <summary>
        /// The motor speeds of the high frequency motor
        /// </summary>
        [SerializeField] public float[] highFrequencyMotorSpeeds;
    ...
    public static class GamepadRumbler
    {
        ...
        public static void Init()
        {
            ...
            {
                syncContext.Post(_ => { ProcessNextRumble(); }, null);
            };
#endif
        }
        ...
        private static void ProcessNextRumble()
        {
            ...
            float lowFrequencySpeed = loadedRumble.lowFrequencyMotorSpeeds[rumbleIndex] *
                                      Mathf.Max(lowFrequencyMotorSpeedMultiplication, 0.0f);
            float highFrequencySpeed = loadedRumble.highFrequencyMotorSpeeds[rumbleIndex] *
                                       Mathf.Max(highFrequencyMotorSpeedMultiplication, 0.0f);
